...
/**
 * Creates tables accomodations, missions and users
 */
class Version20180424075407 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE missions (
          id INT AUTO_INCREMENT NOT NULL, 
          accomodation_id INT NOT NULL, gla_id INT NOT NULL, volunteer_id INT DEFAULT NULL, status VARCHAR(25) NOT NULL, description VARCHAR(3000) NOT NULL, info VARCHAR(1000) DEFAULT NULL, conclusions VARCHAR(3000) DEFAULT NULL, date_created DATE NOT NULL, date_assigned DATE DEFAULT NULL, date_finished DATE DEFAULT NULL, attachment VARCHAR(255) DEFAULT NULL, INDEX IDX_34F1D47EFD70509C (accomodation_id), INDEX IDX_34F1D47EE26B8849 (gla_id), INDEX IDX_34F1D47E8EFAB6B1 (volunteer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
