...
final class Version20190127150248 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE building_inspection_item (id INT AUTO_INCREMENT NOT NULL, headers_id INT NOT NULL, inspection_id INT NOT NULL, comment VARCHAR(1000) DEFAULT NULL, action VARCHAR(25) DEFAULT NULL, decision_maker VARCHAR(25) DEFAULT NULL, INDEX IDX_5AC44BE16F571EDC (headers_id), INDEX IDX_5AC44BE1F02F2DDF (inspection_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
